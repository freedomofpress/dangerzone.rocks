...
1. 🥇 `~/secrets/host.flag` in the host: **$1,700.**
2. 🥈 `/gvisor.flag` within the Podman container: **$1,000.**
3. 🥉 `/home/dangerzone/raster.flag` within the gVisor sandbox: **$300.**
...
4. Submit a PR and let the games begin! 🥳
...
If your submission is successful, we will redirect you to [our Bugcrowd account](https://bugcrowd.com/engagements/freedomofpress) to receive your reward. At the same time though, you will own the exploit. We will assist you in reaching out to the affected parties and help you claim any additional bounties they may offer for the vulnerability.

### 3. Can I experiment with this challenge locally?

Absolutely! You are encouraged to install Dangerzone locally and experiment with creating a document that can read a file from your PC during the sanitization process. Check out our [CI job](https://github.com/freedomofpress/santa-pwn-dangerzone/blob/main/.github/workflows/submit.yml) as well, to see how we plant the flags for the challenge. Once you have crafted your document, feel free to submit the encrypted version as a PR. Happy experimenting!
